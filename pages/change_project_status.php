...
<?php
	...
	$_SESSION["page_name"] = "change_project_status.php";
...
<div class="container">
	<div class="jumbotron" style="text-align: center;">
		<h1>Change Project Status</h1>
	</div>

	<form action="php/change_project_status_action.php" method="POST">
  <!--Beginning of Table-->
  <?php
	include '../php/change_project_status.php';
  ?>
