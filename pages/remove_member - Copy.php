...
<?php
	...
	$_SESSION["page_name"] = "remove_member.php";
...
<form action="php/remove_member_action.php" method="POST">
	<div class="row">
		<div class="col-sm-6">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
				<select id="club_id" class="form-control" name="club_id">
					<option style="color: gray;" disabled selected>Select Club</option>
					<?php
		...
		<div class="col-sm-6">
			<div class="input-group">
				...
				<input type="text" id="student_id" class="form-control" name="student_id" placeholder="Student ID">
			</div>
		</div>
	</div>
			...
			<p style="text-align: center;">
				<input class="btn btn-primary" type="submit" id="submit_button" name="submit_button" value="Remove Selected Member">
			</p>
		</form>
	</div>
  </div>
